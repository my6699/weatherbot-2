...
//
// 也可以手动运行：
//   npx tsx src/scripts/daily-report.ts

import 'dotenv/config';
import { readAllTrades, getTodaySettledTrades, getOpenPositions, getTotalPnL } from '../utils/trade-recorder.js';
import { sendWeComMarkdown } from '../utils/wecom-notifier.js';
import { createModuleLogger } from '../common/logger.js';

const logger = createModuleLogger('DailyReport');
